(function(){
  ...
  function loadAfterCore(){
    ...
    appendScript("js/imc-gw001-schedule-results.js?v=2.0.0");
    appendScript("js/imc-gw001-standings.js?v=1.1.0");
  ...
  if(document.readyState==="loading"){
    ...
    writeScript("js/imc-gw001-schedule-results.js?v=2.0.0");
    writeScript("js/imc-gw001-standings.js?v=1.1.0");
