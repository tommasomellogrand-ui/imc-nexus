(function(){
  ...
  function loadAfterCore(){
    ...
    appendScript("js/imc-nexus-client-bridge.js?v=1.0.0",function(){
      ...
      appendScript("js/imc-competition-country-type-filters.js?v=1.1.0");
      ...
      appendScript("js/imc-managers-gw008.js?v=1.0.0");
    });
  }
  ...
  if(document.readyState==="loading"){
    ...
    writeScript("js/imc-competition-country-type-filters.js?v=1.1.0");
    ...
    writeScript("js/imc-managers-gw008.js?v=1.0.0");
    return;
  }
