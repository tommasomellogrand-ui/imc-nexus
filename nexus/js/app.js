(function(){
  ...
  function loadAfterCore(){
    ...
    appendScript("js/imc-competitions.js?v=1.2.1",function(){
      appendScript("js/imc-competition-ui.js?v=1.2.0");
    });
  }
  ...
  if(document.readyState==="loading"){
    ...
    writeScript("js/imc-competitions.js?v=1.2.1");
    writeScript("js/imc-competition-ui.js?v=1.2.0");
    return;
  }
