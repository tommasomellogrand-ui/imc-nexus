...
const VERSION="1.3.1";
const HERO="assets/road-chronicle/GW001/dortmund-cup/hero.jpg?v=2";
const FINAL="assets/road-chronicle/GW001/dortmund-cup/finale.jpg?v=2";
...
function put(label,src,alt){if(!src)return;for(const slot of document.querySelectorAll(".rc-story-image")){const strong=slot.querySelector("strong");if(!strong||strong.textContent.trim()!==label||slot.dataset.rcImageLoaded==="1")continue;slot.dataset.rcImageLoaded="1";slot.innerHTML=`<img src="${src}" alt="${alt}">`;}}
