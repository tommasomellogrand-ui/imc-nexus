...
function shareUrl(card){const gw=gwFromCard(card),fixture=Number(card.getAttribute("data-fixture-id")),code=codeFor(gw,fixture);return code?`${location.origin}/nexus/s/${code}?v=2`:""}
