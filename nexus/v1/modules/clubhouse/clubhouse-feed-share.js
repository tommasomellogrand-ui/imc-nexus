...
function hydrate(){for(const card of document.querySelectorAll('.ch-feed-card[data-fixture-id]')){if(card.hasAttribute("data-share-ready"))continue;const editorial=card.querySelector(".ch-feed-editorial");if(!editorial)continue;editorial.insertAdjacentHTML("beforeend",buttonMarkup());card.setAttribute("data-share-ready","1")}}
