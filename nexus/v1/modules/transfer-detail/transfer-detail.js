...
async function mount(o){if(!o||!o.container||!o.client||!o.worldId||!o.transferId)throw Error("Transfer Detail: parametri mancanti");s={...s,...o,container:o.container,client:o.client,worldId:c(o.worldId),transferId:c(o.transferId),row:null};s.container.innerHTML='<div class="td-empty">Caricamento Transfer Detail…</div>';await load();render()}
